export const PROMO_TYPES = [
  ...
  // Plan Carta (1)
  { type: 'cart_threshold', label: 'Monto Mínimo (Monto Fijo / %)', minPlan: 1, category: 'Carrito', icon: '' },
  { type: 'category_discount', label: 'Descuento por Categoría', minPlan: 1, category: 'Categoría', icon: '' },
  ...
  { type: 'first_order', label: 'Primer Pedido del Cliente', minPlan: 2, category: 'Fidelización', icon: '' },
  { type: 'delivery_zone', label: 'Domicilio: Gratis por Zona', minPlan: 2, category: 'Domicilio', icon: '' },
];

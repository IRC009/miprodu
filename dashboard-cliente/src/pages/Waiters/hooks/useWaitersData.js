...
export const ROLES = [
  ...
  { value: 'cajero',       label: '💵 Cajero',       defaultFeatures: ['orders', 'tables', 'reservations', 'dashboard', 'cancel_orders', 'bill_orders', 'shift_history'] },
  { value: 'domiciliario', label: '🛵 Domiciliario', defaultFeatures: ['orders'] },
  { value: 'chef',         label: '👨‍🍳 Chef',         defaultFeatures: ['orders'] },
  { value: 'supervisor',   label: '🔑 Supervisor',   defaultFeatures: ['orders', 'tables', 'reservations', 'menu', 'inventory', 'dashboard', 'cancel_orders', 'bill_orders', 'shift_history'] },
  { value: 'admin',        label: '⚙️ Administrador', defaultFeatures: ['all'] },
  { value: 'otro',         label: '🛠️ Otro',         defaultFeatures: [] },
];
...
export const FEATURES = [
  ...
  { id: 'shift_history',  label: 'Historial de Cajas', icon: '🗂️' },
];

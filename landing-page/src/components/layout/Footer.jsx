        ...
        <div className="lp-container footer-inner">
          <div className="footer-brand">
            ...
            <div className="footer-social">
              ...
              <a href="https://wa.me/573026713501" className="footer-social-btn" aria-label="WhatsApp">
            ...
            <div key={group} className="footer-col">
              ...
              <ul className="footer-col-links">
                {links.map(l => {
                  ...
                  return (
                    <li key={l}>
                      <a href={href} target={target} rel={rel} className="footer-link">
                        {l}
                      </a>
                    </li>
                  );

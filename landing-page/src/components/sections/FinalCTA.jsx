      ...
      <div className="lp-container">
        <div ref={contentRef} className="finalcta-content">
          ...
          <p className="finalcta-sub">
            Únete a los restaurantes que ya digitalizaron su operación. {trialDays > 0 ? `${trialDays} días gratis con tarjeta, sin permanencia,` : 'Sin permanencia,'} cancela cuando quieras.
          </p>
          <div className="finalcta-actions">
            <a href="https://app.cartaymesa.com" target="_blank" rel="noopener noreferrer" className="finalcta-primary">
            ...
            <a href="https://wa.me/573026713501?text=Hola,%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20Carta%20y%20Mesa" target="_blank" rel="noopener noreferrer" className="finalcta-secondary">

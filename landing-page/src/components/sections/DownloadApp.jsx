        ...
        <div ref={cardRef} className="download-card">
          <div className="download-content">
            ...
            <h2 className="download-title">
              Descarga la App para <span className="wine-text">Meseros y Staff</span>
            </h2>
            <p className="download-desc">
              Recibe notificaciones sonoras al instante ("tin tin") cuando un cliente necesite atención. Monitorea llamados de mesero, pedidos y el estado de las mesas en tiempo real.
            </p>

            <div className="download-actions">
              {/* Android Download */}
              <a href="/apps/cartaymesa.apk" download className="download-btn android-btn">
              ...
              <div className="phone-screen">
                ...
                <div className="phone-content">
                  <div className="mock-notification">
                    <span className="mock-bell">🔔</span>
                    <div className="mock-notif-body">
                      <strong>Llamado de Mesero</strong>
                      <p>Mesa 4 necesita atención</p>
                    </div>
                    <span className="mock-time">Ahora</span>
                  </div>
                  <div className="mock-app-body">
                    <div className="mock-app-header">
                      <span>Carta y Mesa</span>
                    </div>
                    <div className="mock-card active">
                      <div className="mock-badge">🔔 Mesa 4</div>
                      <div className="mock-elapsed">Hace 1 min</div>
                      <div className="mock-action">Atendido</div>
                    </div>
                    <div className="mock-card">
                      <div className="mock-badge">🔔 Mesa 2</div>

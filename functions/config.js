...
module.exports = {
  ...
  MP_ACCESS_TOKEN: IS_PRODUCTION 
    ...
    : "TU_ACCESS_TOKEN_TEST_MP_AQUI",
  
  CURRENCY: "COP", // <-- CAMBIA ESTO SI TU CUENTA DE MP ES DE OTRO PAÍS (MXN, ARS, etc.)
  
  MP_WEBHOOK_SECRET: process.env.MP_WEBHOOK_SECRET || "TU_MP_WEBHOOK_SECRET_AQUI",
  ...
  CF_EMAIL:     process.env.CF_EMAIL     || "tu-correo@dominio.com",
